"""Signal 3 — XGBoost (frs_3). val NDCG@3 = 0.623."""
...
@series_signal(
    signal_id=3,
    note="ML: XGBoost frs_3 predictor (valNDCG3=0.623)",
    category="ML",
    required=REQUIRED,
)
def ml_3_xgboost(big: pd.DataFrame, **kwargs) -> pd.DataFrame:
    artifact = load_model(3)
