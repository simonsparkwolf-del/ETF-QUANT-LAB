"""Signal 1 — LightGBM (frs_3). val NDCG@3 = 0.639."""
...
@series_signal(
    signal_id=1,
    note="ML: LightGBM frs_3 predictor (valNDCG3=0.639)",
    category="ML",
    required=REQUIRED,
)
def ml_1_lightgbm(big: pd.DataFrame, **kwargs) -> pd.DataFrame:
    artifact = load_model(1)
