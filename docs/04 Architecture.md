...
#### 2. Ranking score — A composite signal for model prediction and historic evaluation
...
3. There will be many versions of the ranking score.
...
1. Rank the ETFs according to the ranking score.
