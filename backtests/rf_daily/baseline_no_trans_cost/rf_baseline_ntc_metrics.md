...
## Output Files
- `rf_baseline_ntc_metrics.json`: machine-readable metrics
- `rf_baseline_ntc_metrics.md`: human-readable metrics summary
- `rf_baseline_ntc_value_history.csv`: portfolio value time series
- `rf_baseline_ntc_holding_history.csv`: position snapshots
- `rf_baseline_ntc_all_in_one_panel.png`: high-resolution all-in-one dashboard
